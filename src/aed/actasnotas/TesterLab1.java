...
public class TesterLab1 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_1(), results_sofar, "test_1", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_2(), results_sofar, "test_2", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_3(), results_sofar, "test_3", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_4(), results_sofar, "test_4", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_5(), results_sofar, "test_5", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_6(), results_sofar, "test_6", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_7(), results_sofar, "test_7", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_8(), results_sofar, "test_8", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_9(), results_sofar, "test_9", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_10(), results_sofar, "test_10", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_11(), results_sofar, "test_11", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_12(), results_sofar, "test_12", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_13(), results_sofar, "test_13", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_14(), results_sofar, "test_14", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_15(), results_sofar, "test_15", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_16(), results_sofar, "test_16", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_17(), results_sofar, "test_17", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_18(), results_sofar, "test_18", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_19(), results_sofar, "test_19", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_20(), results_sofar, "test_20", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_21(), results_sofar, "test_21", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_22(), results_sofar, "test_22", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas")) {
				results_sofar = combine_results(test_23(), results_sofar, "test_23", "actasnotas");
			}

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_24(), results_sofar, "test_24", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_25(), results_sofar, "test_25", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_26(), results_sofar, "test_26", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_27(), results_sofar, "test_27", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_28(), results_sofar, "test_28", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_29(), results_sofar, "test_29", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_30(), results_sofar, "test_30", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_31(), results_sofar, "test_31", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_32(), results_sofar, "test_32", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_33(), results_sofar, "test_33", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_34(), results_sofar, "test_34", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_35(), results_sofar, "test_35", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_36(), results_sofar, "test_36", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_37(), results_sofar, "test_37", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_38(), results_sofar, "test_38", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_39(), results_sofar, "test_39", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_40(), results_sofar, "test_40", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_41(), results_sofar, "test_41", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_42(), results_sofar, "test_42", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_43(), results_sofar, "test_43", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_44(), results_sofar, "test_44", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_45(), results_sofar, "test_45", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_46(), results_sofar, "test_46", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_47(), results_sofar, "test_47", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_48(), results_sofar, "test_48", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_49(), results_sofar, "test_49", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_50(), results_sofar, "test_50", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_51(), results_sofar, "test_51", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_52(), results_sofar, "test_52", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_53(), results_sofar, "test_53", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_54(), results_sofar, "test_54", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_55(), results_sofar, "test_55", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_56(), results_sofar, "test_56", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_57(), results_sofar, "test_57", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_58(), results_sofar, "test_58", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_59(), results_sofar, "test_59", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_60(), results_sofar, "test_60", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_61(), results_sofar, "test_61", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_62(), results_sofar, "test_62", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_63(), results_sofar, "test_63", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_64(), results_sofar, "test_64", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_65(), results_sofar, "test_65", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_66(), results_sofar, "test_66", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_67(), results_sofar, "test_67", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_68(), results_sofar, "test_68", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_69(), results_sofar, "test_69", "actasnotas");

			if (results_ok_sofar(results_sofar, "actasnotas") && local_results_ok_sofar(results_sofar, "actasnotas"))
				results_sofar = combine_results(test_70(), results_sofar, "test_70", "actasnotas");
	...
	static boolean get_fail(String matricula) {
		...
		try {
			...
			ok_sofar = false;
			printError(ExecutionTime.LAST, "\nthe call to getCalificacion returned the value " + cal
					+ ", but should have raised the exception " + "InvalidMatriculaException");
		...
		try {
			...
			if (!expectedResult) {
				...
				printError(ExecutionTime.LAST, "\nthe call to addCalificacion returned normally"
						+ ", but should have raised the exception " + "CalificacionAlreadyExistsException");
			}
	...
	static boolean getAprobados(int notaMinima, PositionList<Calificacion> expected) {
		...
		try {
			IndexedList<Calificacion> result = actaNotasAED.getAprobados(notaMinima);
			if (result == null) {
				ok_sofar = false;
	...
	static boolean sort(int comparator, PositionList<Calificacion> expected) {
		...
		try {
			...
			IndexedList<Calificacion> result = actaNotasAED.getCalificaciones(cmp);
				...
				if (ok_sofar) {
					...
					while (i < ts1.size()) {
						...
						while (j < ts2.size() && !found) {
							...
							if (!found) {
								if (equal_comparator(comparator, c1, c2))
									++j;
								else
									break;
							}
	...
	static int test_type_to_index(String test_type) {
		if (test_type.equals("actasnotas"))
			return 0;
